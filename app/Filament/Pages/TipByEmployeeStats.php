...
class TipByEmployeeStats extends Page implements HasTable, HasForms
{
    use InteractsWithTable;
    use InteractsWithForms;

    protected static ?string $navigationLabel = 'Thống kê Tip theo nhân viên';

    protected static ?string $title = 'Thống kê Tip theo nhân viên';
    ...
    protected string $view = 'filament.pages.tip-by-employee-stats';
    ...
    public static function canAccess(): bool
    {
        ...
        try {
            return $user->hasPermissionTo('View:TipByEmployeeStats') || $user->hasRole('admin');
