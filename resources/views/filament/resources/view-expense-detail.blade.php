<div class="space-y-6">
    {{-- Section 1: Thông tin Chi --}}
    <div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
        <div class="bg-danger-50 border-b border-danger-200 px-6 py-4">
            <h3 class="text-lg font-bold text-gray-900">Thông tin Chi</h3>
        </div>
        <div class="p-6">
            <div class="overflow-x-auto">
                <table class="w-full">
                    <tbody class="divide-y divide-gray-200">
                        <tr>
                            <td class="py-3 px-4 text-right font-medium text-gray-700 w-1/2">Số tiền chi:</td>
                            <td class="py-3 px-4 text-left text-gray-900">{{ number_format($record->amount, 0, ',', '.') }} ₫</td>
                        </tr>
                        <tr>
                        ...
                        @endif
                        <tr class="bg-danger-50 font-bold">
                            <td class="py-3 px-4 text-right text-gray-900">Tổng chi:</td>
                            <td class="py-3 px-4 text-left text-danger-600 text-lg">{{ number_format($record->amount, 0, ',', '.') }} ₫</td>
                        </tr>
                    </tbody>
                </table>
            </div>
